/* Haydar Pack V46 cleanup bundle: 06-data-protection-images-backup.js
...
(function(){
  ...
  window.hpStage6HardReload=async function(){
    ...
    location.href=base+'?v=46corecleanup&safeReload='+Date.now();
  };
  function panelHtml(){
...
(function(){
  ...
  var SITE_VERSION='46corecleanup';
  var LOCAL_KEY='hayder_bags_app';
